...
_Avoid_: transactions list (ambiguous with the Itemized List page, and with the Void page specified in #62 — the same table with status pinned and a Void action per row); receipts page (a Series receipt is a different thing entirely — see above)
